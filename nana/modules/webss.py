...
async def ssweb(client, message):
	...
	await client.send_photo(message.chat.id, photo="nana/cache/web.png", caption=capt, reply_to_message_id=message.message_id)
...
async def ssweb(client, message):
	...
	await client.send_document(message.chat.id, document="nana/cache/web.png", caption=capt, reply_to_message_id=message.message_id)
	os.remove("nana/cache/web.png")
	await client.send_chat_action(message.chat.id, action="cancel")
